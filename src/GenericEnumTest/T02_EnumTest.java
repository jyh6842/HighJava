...
public class T02_EnumTest {
	...
	public enum Season{
		봄("3월부터 5월까지"), 여름("6월부터 8월까지"), 가을("12월부터 2월까지"),겨울("12월부터 2월까지"); // 시즌타입의 봄 객체 하나 만들어지고, 시즌타입의 여름 객체 하나 만들어지고,
	...
	public static void main(String[] args) {
		/*
		 	...
		 	3. valueOf("열거형 상수이름") => 지정된 열거형에서 '열거형사수이름'과 일치하는 열거형 상수를 반환한다.
		
		*/
		
		City myCity1; // 열거형 객체변수 선언 // enum을 정해놓으면 클래스를 정해 놓은 것 처럼 쓸 수 있다.
		City myCity2; // mycity는 타입임
		
		// 열거형 객체변수에 값 저장하기
		myCity2 = City.서울; //객체 서울
		myCity1 = City.valueOf("서울"); // City enuim에서 '서울'인 객체 반환 //이건 스티링 서울
		...
		City city = City.대구; // city타입의 '대구'라는 enum상수
		
		// System.out.println(Season.서울 == City.대전); // 타입이 다르기 때문에 비교할 수가 없다.
