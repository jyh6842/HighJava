 ...
 */
	 ...
	 * @param course 모든과정
	 */
	public static void registerCourse(Course<?> course) { //아직 정해지지 않았음 여기 올수 있는 타입은 모든 타입
	 ...
	 * @param course
	 */
	// public static <T extends Studnet> void registerCourseStudent(Course<T> course) 와 밑의 것과 동일하다. 단 위의 public static <T> void registerCourse(Course<T> course)로 바꿔줘야 된다. 
...
class Course<T>{
	...
	public Course(String name, int capacity) {
		this.name = name;
		// 타입 파라미터로 배열을 생성시 오브젝트 배열을 생성후, 타입 파라미터 배열로
		// 캐스팅 처리해야 함.
