...
public class T10_TreeSetTest {
	...
	public static void main(String[] args) {
		...
		for (char ch = 'Z'; ch >= 'A'; ch--) {// 정렬되는지 확인하기 위해서 0번인덱스에 Z를 넣는다.
			String temp = String.valueOf(ch);
			ts.add(temp);
		}
		
		System.out.println("TestSet 자료 : " + ts);
		...
		System.out.println("K 이전 자료 : " + ss2); // 기준값 미포함
		System.out.println("K 이전 자료(기준값 포함) : " + ts.headSet("K", false));
