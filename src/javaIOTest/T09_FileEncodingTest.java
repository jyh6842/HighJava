...
/*
     ...
     *	인코딩방식
        ...
        원래 한글윈도우는 CP949방식을 사용했는데, 윈도우를 개발한 마이크로소프트
        에서 EUC-KR 방식에서 확장하였기 때문에 MS949라고도 부른다.
        한글Windows의 메모장에서 말하는 ANSI인코딩이란, CP949(Code Page 949)
        를 말한다. CP949는 EUC-KR의 확장이며, 하위호환성이 있다.
     	...
     	* 유니코드(Unicode)
     	...
     	이런 문제점을 해결하기 위해 전 세계의 모든 문자르 하나의 통일된 문자집합
     	(CharSet)으로 표현함.
     	처음엔 2byte(65536)으로 표현했지만, 부족해져 21bit(약 200만 문자)로 확장
     	되었다. 
...
public class T09_FileEncodingTest { //
	public static void main(String[] args) {
		...
		try {
			 ...
			 */
			fis = new FileInputStream("d:/D_Other/test_ansi.txt"); // 파일형식 ANSI
//			fis = new FileInputStream("d:/D_Other/test_utf-8.txt"); // 파일형식 UTF-8
			
			
//			isr = new InputStreamReader(fis, "cp949");//ANSI
//			isr = new InputStreamReader(fis, "UTF-8");
//			isr = new InputStreamReader(fis, "euc-kr");//ANSI
